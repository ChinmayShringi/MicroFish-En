...
class OasisProfileGenerator:
    ...
    def _search_zep_for_entity(self, entity: EntityNode) -> Dict[str, Any]:
        """
        Uses Zep graph hybrid search to get rich information related to an entity
        ...
        try:
            ...
            logger.info(f"Zep hybrid retrieval completed: {entity_name}, fetched {len(results['facts'])} facts, {len(results['node_summaries'])} related nodes")
    ...
    def _get_system_prompt(self, is_individual: bool) -> str:
        """Get system prompt"""
        base_prompt = "You are a social media user profile generation expert. Generate detailed, realistic personas for public opinion simulation, maximizing fidelity to existing real-world conditions. Must return valid JSON format. All string values must not contain unescaped newlines. Use Chinese."
        return base_prompt
...
- Institutional account communication must match its identity positioning"""
    ...
    def generate_profiles_from_entities(
        ...
        Args:
            ...
            graph_id: Graph ID for Zep retrieval of richer context
